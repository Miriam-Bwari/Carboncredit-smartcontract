...
sealed class BottomTab(
    ...
    data object AdminAgents :
        BottomTab("Agents", AdminAgentsKey, Icons.Filled.Groups, Icons.Outlined.Groups)

    // Agent tabs (3 tabs)
    data object AgentHome : BottomTab("Home", AgentHomeKey, Icons.Filled.Home, Icons.Outlined.Home)
    data object AgentFarmers :
        BottomTab("Farmers", AgentFarmersKey, Icons.Filled.Groups, Icons.Outlined.Groups)
    ...
    data object FarmerHome :
        BottomTab("Home", FarmerHomeKey, Icons.Filled.Home, Icons.Outlined.Home)

    data object FarmerDrought :
        BottomTab("Drought", FarmerDroughtKey, Icons.Filled.WbSunny, Icons.Outlined.WbSunny)

    data object FarmerMyFarm :
        BottomTab("My Farm", FarmerMyFarmKey, Icons.Filled.Agriculture, Icons.Outlined.Agriculture)

    data object FarmerCarbon :
        BottomTab("Carbon", FarmerCarbonKey, Icons.Filled.Eco, Icons.Outlined.Eco)

    data object FarmerProfile :
        BottomTab("Profile", FarmerProfileKey, Icons.Filled.Person, Icons.Outlined.Person)

    companion object {
        val adminTabs = listOf(AdminHome, AdminMap, AdminAgents)
        val agentTabs = listOf(AgentHome, AgentFarmers, AgentSync)
        val farmerTabs =
            listOf(FarmerHome, FarmerDrought, FarmerMyFarm, FarmerCarbon, FarmerProfile)
    }
}
