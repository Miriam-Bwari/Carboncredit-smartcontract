        ...
        return try {
            ...
            for (farm in pendingFarms) {
                ...
                try {
                    ...
                    Timber.e(e, "Failed to register farmer, continuing to next item")
                    // If phone is already registered, backend might throw 400. 
                    // We might need to handle this gracefully later, but for now we continue 
                    // because maybe the farmer already existed.
                }
                ...
                val farmDto = FarmRegisterRequestDto(
                    farmerId = farm.farmerId, // Wait, backend returns a new farmer ID. 
                    // This is a known caveat if UUIDs are generated by backend. 
                    // In a true offline-first system, UUIDs are generated client-side 
                    // and backend accepts them. We will send our client UUID.
